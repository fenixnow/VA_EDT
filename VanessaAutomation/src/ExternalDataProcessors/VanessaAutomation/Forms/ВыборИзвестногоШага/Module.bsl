...
Процедура УстановитьУсловноеОформление()
	...
	Элементы.ГруппаОписание.Видимость = ОтобразитьОбластьОписания;
...
&НаКлиенте
Процедура ИзменитьОтображениеОписания(Команда)

	ИзменитьОтображениеОписанияНаСервере();

КонецПроцедуры

&НаСервере
Процедура ИзменитьОтображениеОписанияНаСервере()

	ОтобразитьОбластьОписания = Не ОтобразитьОбластьОписания;
...
&НаСервере
Процедура ИзменитьВидимостьОписания()
