...
Сценарий: Генерация EPF на английском простая
	И Я запоминаю значение выражения 'Ванесса.Объект.КаталогИнструментов + "/features/Support/Templates/features/ФичаДляПроверкиГенерацииEPFАнглийский.epf"' в переменную "СлужебныйФайл"
