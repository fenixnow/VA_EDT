...
Контекст: 
	...
	И     В поле с именем "КаталогФичСлужебный" я указываю путь к каталогу фич "Support\Templates\features\ФичиДляПровериРаботыТегов"
...
Сценарий: Исключение по тегу сценария когда идёт загрузка одной фичи
	...
	И     В поле с именем "КаталогФичСлужебный" я указываю путь к каталогу фич "Support\Templates\features\ФичиДляПровериРаботыТегов\ТегВторойСценарий.feature"
